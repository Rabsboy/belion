...
<head>
    ...
    <style>
        ...
        .status-box { background-color: #f5f3ff; border: 1px solid #ddd6fe; padding: 15px; border-radius: 8px; margin-bottom: 20px; text-align: center; }
    ...
    <div class="container">
        ...
        <div class="content">
            <div class="status-box">
                <strong style="color: #8b5cf6; font-size: 18px;">OUT FOR DELIVERY</strong><br>
                Order #{{ str_pad($order->id, 6, '0', STR_PAD_LEFT) }} is being delivered to the customer.
            </div>
            ...
            <p>
                ...
                <strong>Tracking:</strong> {{ $order->delivery_tracking_url ?? 'None provided' }}
            </p>

...
export default function Menu({ categories, products, filters }) {
    ...
    return (
        <PublicLayout>
            ...
            {/* Hero Section */}
            <section className="relative overflow-hidden bg-gradient-to-b from-orange-50 via-white to-amber-50 py-12 md:py-16">
                ...
                <div className="relative max-w-6xl mx-auto px-4 md:px-8 grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                    <div className="space-y-4">
                        <p className="inline-flex items-center px-4 py-2 rounded-full bg-white shadow-sm text-orange-600 text-sm font-semibold w-fit">
                            {m['menu.hero_tagline']}
                        </p>
                    ...
                    <div className="rounded-3xl bg-white/80 backdrop-blur border border-orange-100 shadow-lg p-6 flex flex-col gap-4">
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full pl-10 pr-4 py-2.5 rounded-lg border border-gray-200 focus:border-orange-500 focus:ring-2 focus:ring-orange-200 transition"
                            />
                        </div>
            ...
            <section className="max-w-6xl mx-auto px-4 md:px-8 pb-6">
                <div className="sticky top-20 z-10 -mx-4 md:-mx-8 px-4 md:px-8 py-3 backdrop-blur bg-white/70 border-b border-orange-100 flex items-center justify-between gap-3">
                    <div>
                        <p className="text-sm font-semibold text-orange-600">
                            {m['menu.browse_by_category']}
                        </p>
                        <p className="text-sm text-gray-500">
                            {m['menu.tap_to_filter']}
                        </p>
                    </div>
                </div>
                <div className="w-full py-4">
                    <div className="relative w-full">
                        <div className="flex flex-row gap-2 overflow-x-auto no-scrollbar whitespace-nowrap py-2 px-1">
                            <button
                                className={`rounded-lg px-4 py-2 flex-shrink-0 font-medium transition-all duration-200 ${
                ...
                {productListData.length > 0 ? (
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {productListData.map((product) => (
                            <div
                                key={product.id}
                                className="group h-full rounded-2xl border border-orange-100 bg-white shadow-sm hover:shadow-lg transition-shadow duration-200 overflow-hidden flex flex-col"
                            >
                                <div className="relative aspect-[4/3] w-full overflow-hidden bg-orange-50">
                                    ...
                                    <div className="absolute left-3 top-3 px-3 py-1 rounded-full bg-white/90 text-xs font-semibold text-orange-700 border border-orange-100">
                                        {m['menu.popular_pick']}
                                    </div>
                                </div>
                                ...
                                <div className="flex-1 flex flex-col gap-3 p-4">
                                    <div className="flex items-start justify-between gap-3">
                                        ...
                                        <span className="text-base font-semibold text-orange-700 whitespace-nowrap">
                                    ...
                                    <button
                                        ...
                                        className="mt-auto inline-flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-orange-600 to-orange-500 text-white px-4 py-2 font-semibold shadow hover:shadow-md transition-all duration-200"
                                    >
